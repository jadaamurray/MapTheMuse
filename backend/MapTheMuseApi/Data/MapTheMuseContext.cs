...
namespace MapTheMuseApi.Data
{
    public class MapTheMuseContext : IdentityDbContext<IdentityUser>
    {
        ...
        public DbSet<MapTheMuseApi.Models.UserArtEngagement> UserArtEngagement { get; set; } = default!;
        public DbSet<MapTheMuseApi.Models.UserMediaEngagement> UserMediaEngagement { get; set; } = default!;
