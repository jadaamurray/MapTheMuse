...
let theme = createTheme({
  palette: {
    ...
    secondary: { main: "rgba(250, 198, 104, 1)" }, // variable-collection-secondary-apricot
    error:     { main: "#f44336" }, // lightgrey
    background:{ "default": "rgba(252,248,239,1)", paper: "rgba(255,254,251,1)", cream: "#FCF8EF" },
